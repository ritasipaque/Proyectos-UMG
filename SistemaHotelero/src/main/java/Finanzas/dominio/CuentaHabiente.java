...
public class CuentaHabiente {
  ...
  private String TipoPersona_CuentaHabiente; 
    ...
    public CuentaHabiente(String Codigo_CuentaHabiente, String Nombre_CuentaHabiente, String ApellidoP_CuentaHabiente, String ApellidoM_CuentaHabiente, String TipoPersona_CuentaHabiente) {
    ...
    public String toString() {
        return "CuentaHabiente{" + "Codigo_CuentaHabiente=" + Codigo_CuentaHabiente + ", Nombre_CuentaHabiente=" + Nombre_CuentaHabiente + ", ApellidoP_CuentaHabiente=" + ApellidoP_CuentaHabiente + ", ApellidoM_CuentaHabiente=" + ApellidoM_CuentaHabiente + ", TipoPersona_CuentaHabiente=" + TipoPersona_CuentaHabiente + '}';
    }
