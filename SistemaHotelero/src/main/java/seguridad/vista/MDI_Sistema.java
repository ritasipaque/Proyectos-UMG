...
public class MDI_Sistema extends javax.swing.JFrame {
    ...
    private void JMenuItem_AplicacionesActionPerformed(java.awt.event.ActionEvent evt) {                                                       
    ...
    private void JMenuItem_PerfilesActionPerformed(java.awt.event.ActionEvent evt) {                                                   
      formMantenimiento_Perfil = new Mantenimiento_Perfil();
      JDesktopPane_Escritorio.add(formMantenimiento_Perfil);
      
    }                                                  

    private void JMenuItem_ApPActionPerformed(java.awt.event.ActionEvent evt) {                                              
        // TODO add your handling code here:
        NuevaVentana = new Aplicacion_Perfil();
        JDesktopPane_Escritorio.add(NuevaVentana);
    }                                             

    private void JMenuItem_ApMActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    private void JMenuItem_UsuariosActionPerformed(java.awt.event.ActionEvent evt) {                                                   
